...
public class EthernetManager {
     ...
     * @hide
     */
    public static final String SETTINGS_SECURE_ETHERNET_ON = "ethernet_on";
    ...
    public String getHwAddress(String iface){
    	try {
            return mService.getHwAddress(iface);
        } catch (NullPointerException | RemoteException e) {
            return null;
        }
    }
    
    public int getEthernetInterfaceState(){
    	try {
            return mService.getEthernetInterfaceState();
        } catch (NullPointerException | RemoteException e) {
    ...
    public boolean setEthernetEnabled(boolean enable)
    {
        ...
        try {
            return mService.setEthernetEnabled(enable);
        } catch (RemoteException e) {
            return false;
        }
    ...
    public boolean setInterfaceEnable(String iface , boolean enable)
    {
        Log.d(TAG,"setInterfaceEnable() : "+iface+" -> "+enable);
        try {
            return mService.setInterfaceEnable(iface,enable);
        } catch (RemoteException e) {
            return false;
        }
