...
//$_rbox_$_modify_$_end
	...
	filter.addAction(SYSTEMUI_FIREFLY_POWEROFF_ACTION);
        ...
        IntentFilter kfilter=new IntentFilter();
        kfilter.addAction("com.android.systemui.ACTION_SHOW_GLOBAL");
        context.registerReceiver(mShowGlobalActionsReceiver, kfilter);
