...
class GlobalActions implements DialogInterface.OnDismissListener, DialogInterface.OnClickListener  {
    ...
    private static final boolean SHOW_SILENT_TOGGLE = false;///true
    ...
    private GlobalActionsDialog createDialog() {
        ...
        mItems.add(
            new SinglePressAction(
                    com.android.internal.R.drawable.ic_lock_firefly_reboot,
                    R.string.factorytest_reboot) {

                public void onPress() {
                    // shutdown by making sure radio and power are handled accordingly.
                    mWindowManagerFuncs.firefly_reboot(false);
                }
        ...
        try{
            File f=new File("/dev/block/rknand_linuxroot");
            if(f.exists()){
                 // next: Ubuntu switch
                mItems.add(
                    new SinglePressAction(
