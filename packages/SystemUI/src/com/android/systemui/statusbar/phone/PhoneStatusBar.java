...
final Object mScreenshotLock = new Object();
    ...
    private void prepareNavigationBarView() {
        ...
        mNavigationBarView.getRotationButton().setOnTouchListener(mRotationActionListener);
        updateSearchPanel();
    ...
    private View.OnTouchListener mRotationActionListener = new View.OnTouchListener() {
		@Override
		public boolean onTouch(View v, MotionEvent event) {
