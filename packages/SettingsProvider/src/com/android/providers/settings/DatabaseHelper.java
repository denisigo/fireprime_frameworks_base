...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void loadSecureSettings(SQLiteDatabase db) {
	    ...
	    else
	    {
            ...
            if (SystemProperties.getBoolean("ro.ethernet_on", true) == true) {
                loadSetting(stmt, android.net.EthernetManager.SETTINGS_SECURE_ETHERNET_ON
                	,android.net.EthernetManager.ETHER_IFACE_STATE_UP);
            } else {
                loadSetting(stmt, android.net.EthernetManager.SETTINGS_SECURE_ETHERNET_ON
                	,android.net.EthernetManager.ETHER_IFACE_STATE_DOWN);
            }
